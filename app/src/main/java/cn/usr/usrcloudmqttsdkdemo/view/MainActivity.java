...
public class MainActivity extends UsrBaseActivity implements View.OnClickListener {
    ...
    {
        main_btn_subscribe.setClickable(state);
        main_btn_publish.setClickable(!state);
        if(state)
        {
            main_btn_publish.setBackgroundResource(R.drawable.cancleshape);
            main_btn_subscribe.setBackgroundResource(R.drawable.button_shape);
        }
        else
        {
            main_btn_subscribe.setBackgroundResource(R.drawable.cancleshape);
            main_btn_publish.setBackgroundResource(R.drawable.button_shape);
        }
    }
